    ...
    <div className="landing-page">
      <header className="landing-header">
        ...
        <div className="connect-section">
          ...
          <a href={SOCIAL_LINKS.facebook} target="_blank" rel="noopener noreferrer" className="social-link facebook" aria-label="Facebook">
          ...
          <a href={SOCIAL_LINKS.instagram} target="_blank" rel="noopener noreferrer" className="social-link instagram" aria-label="Instagram">
